...
const NetentSlotsTops = () => {
        ...
        const fetchData = async () => {
          try {
            const response = await fetch(
              'http://player.staging.smash.t1t.in/pub/get_frontend_games/5942'
            );
    ...
    return (
            ...
            <div className='pb-6'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='swiper__navigation__btn relative flex justify-end items-center gap-3'>
                        ...
                        <div className='relative flex grid-cols-2 gap-3'>
                            <i className="icon-arrow-long-left slots-top-netent-swiper-button-prev dark-1 w-[65px] h-[45px] rounded-lg z-10 flex justify-center items-center cursor-pointer">
                                <IconChevronLeft color='orange' />     
                            </i>
                            <i className="icon-arrow-long-right slots-top-netent-swiper-button-next dark-1 w-[65px] h-[45px] rounded-lg z-10 flex justify-center items-center cursor-pointer">
                ...
                <div className='game__wrapper relative w-full'>
                    ...
                    loop={true}
                    navigation={{
                        nextEl: '.slots-top-netent-swiper-button-next',
                        prevEl: '.slots-top-netent-swiper-button-prev',
                    }}
                    modules={[Navigation]}
                    >
                        {filteredGames ? (
  ...
  export default NetentSlotsTops;