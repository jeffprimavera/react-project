    ...
    <section className='pb-2'>
        ...
        <div className='w-full grid grid-cols-2 items-center gap-3'>
            ...
            <div className="hp__banners__bg casino__bg">
                <div className="hpb__content__wrapper">
                    ...
                    <button className="btn mt-5 bg-gradient-blueraspberry border-0 block w-full">Play Now</button>
                </div>
            </div>
            ...
            <div className="hp__banners__bg sports__bg">
                <div className="hpb__content__wrapper">
                        ...
                        <button className="btn mt-5 bg-gradient-lemontwist border-0 block w-full">Play Now</button>
                    </div>
            </div>
        </div>
        ...
        <div className="w-full relative overflow-hidden mt-10">
            ...
            <div className='absolute right-[145px] top-16 text-white font-semibold text-2xl'>
                ...
                <button className='btn bg-gradient-blueraspberry mt-3 w-[182px] h-[52px]'>Deposit</button>
            </div>
        </div>
